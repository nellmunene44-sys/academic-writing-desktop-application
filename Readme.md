# Academic Roadmap Coach (Local-first Desktop MVP)
...
npm run dev
```
3. Complete onboarding (targets, platforms, pricing, success metric).
4. Go to Dashboard to see today’s priority and income trajectory.
5. Use Today to start timers and complete tasks.
6. Log income and reflections daily.
